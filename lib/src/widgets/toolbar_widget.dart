          ...
          child: CustomDropdownButtonHideUnderline(
            child: CustomDropdownButton<String>(
              ...
              onChanged: (String? changed) async {
                ...
                if (changed != null) {
                  var proceed =
                      await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.style, changed, updateSelectedItem) ?? true;
                  if (proceed) {
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  ...
                  if (changed != null) {
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.fontName, changed, updateSelectedItem) ?? true;
                    if (proceed) {
              ...
              child: CustomDropdownButton<double>(
                ...
                onChanged: (double? changed) async {
                  ...
                  if (changed != null) {
                    ...
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.fontSize, changed, updateSelectedItem) ?? true;
                    if (proceed) {
                      switch (intChanged) {
                        case 1:
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  ...
                  if (changed != null) {
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.fontSizeUnit, changed, updateSelectedItem) ??
                            true;
                    if (proceed) {
                      updateSelectedItem(changed);
                    }
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.format_bold) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.bold, _fontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_italic) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.italic, _fontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_underline) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.underline, _fontSelected[index], updateStatus) ?? true;
                if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons2()[index].icon == Icons.superscript) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.superscript, _miscFontSelected[index], updateStatus) ??
                        true;
                if (proceed) {
              ...
              if (t.getIcons2()[index].icon == Icons.subscript) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.subscript, _miscFontSelected[index], updateStatus) ??
                        true;
                if (proceed) {
          ...
          onPressed: (int index) async {
            ...
            if (_colorSelected[index]) {
              ...
              if (t.getIcons()[index].icon == Icons.format_color_fill) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.highlightColor, _colorSelected[index], updateStatus) ??
                        true;
                if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons()[index].icon == Icons.format_list_bulleted) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.ul, _listSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons()[index].icon == Icons.format_list_numbered) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.ol, _listSelected[index], updateStatus) ?? true;
                if (proceed) {
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  ...
                  if (changed != null) {
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.listStyles, changed, updateSelectedItem) ??
                            true;
                    if (proceed) {
                      if (kIsWeb) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_left) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignLeft, _alignSelected[index], updateStatus) ??
                        true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_center) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignCenter, _alignSelected[index], updateStatus) ??
                        true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_right) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignRight, _alignSelected[index], updateStatus) ??
                        true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_justify) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignJustify, _alignSelected[index], updateStatus) ??
                        true;
                if (proceed) {
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<double>(
                ...
                onChanged: (double? changed) async {
                  ...
                  if (changed != null) {
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.lineHeight, changed, updateSelectedItem) ??
                            true;
                    if (proceed) {
                      if (kIsWeb) {
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  if (changed != null) {
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.caseConverter, changed, null) ?? true;
                    if (proceed) {
                      if (kIsWeb) {
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    ElevatedButton(
                                      ...
                                      child:
                                          Text('Open in new window', style: TextStyle(color: Theme.of(context).textTheme.bodySmall?.color)),
                                    ),
                                  ],
                                ),
                              ]),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(url.text, InsertFileType.image) ??
                                            true;
                                    if (proceed) {
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(url.text, InsertFileType.audio) ??
                                            true;
                                    if (proceed) {
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(url.text, InsertFileType.video) ??
                                            true;
                                    if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.fullscreen) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.fullscreen, _miscSelected[index], updateStatus) ??
                        true;
                if (proceed) {
